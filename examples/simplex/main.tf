...
module "ncc_spoke" {
  ...
  ssr_internal_private_address = module.ssr.ssr_internal_private_address
  ssr_self_link                = module.ssr.ssr_self_link
  depends_on                   = [module.gcp_router, module.ssr]
}